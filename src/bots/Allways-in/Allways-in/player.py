...
class GhostBot(Player):
    ...
    def _load_strategy(self):
        try:
            ...
            return CFRTrainer.load_strategy(_STRATEGY_PATH)
        except FileNotFoundError:
            print("[GhostBot] strategy.pkl not found — "
                  "run train.py before the tournament. Using heuristic fallback.")
            return None
        except Exception as e:
            print(f"[GhostBot] Could not load strategy: {e}. "
